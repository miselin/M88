...
software interrupt. This section outlines the services provided by the \m88 BIOS.
...
\node (add1) [process, below of=waitidle1] {Write the slave address to I/O Port \texttt{0x3A0}.};
